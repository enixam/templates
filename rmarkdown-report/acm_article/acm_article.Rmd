...
author:
  - name: Qiushi Yan ^[https://qiushi.rbind.io]
    email: "website: https://qiushi.rbind.io email: qiushi.yann@gmail.com" 
...
```{r diamond-plot, fig.cap = "this is a figrue"}
plot(mtcars[1:2])
```

Please see figure \@ref(fig:diamond-plot)
...
this line reference equation \@ref(eq:haha)
